...
public class checkoutpage {
	WebDriver driver;
	//By radiobutton1 = By.xpath("/html/body/div[2]/div/div/div/div[2]/div[2]/div/form/div[1]/label/input");
	...
	By lastname = By.id("input-payment-lastname");
	   ...
	   //country and state drop down
	    ...
	    By newaddresscontinue = By.linkText("Continue");
	   ...
	   //country and state drop down
	    ...
	    By newaddresscontinuedlry = By.xpath("//*[@id=\\\"button-shipping-address\\\"]");
	    By dlrycontinue = By.xpath("//*[@id=\"button-shipping-method\"]");
	    By clickcheckbox = By.xpath("By radiobuttondlry = By.xpath(\"//*[@id=\\\"collapse-shipping-address\\\"]/div/form/div[3]/label\");");
	    By paymentcontinue = By.xpath("//*[@id=\"button-payment-method\"]");
	    By confirmsubmit = By.xpath("//*[@id=\"button-confirm\"]");
